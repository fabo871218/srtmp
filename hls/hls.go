...
// func (server *Server) NewWriter(streamInfo av.StreamInfo) (av.WriteCloser, error) {
// 	var s *Source
// 	ok := server.conns.Has(streamInfo.Key)
// 	if !ok {
// 		s = NewSource(streamInfo)
// 		server.conns.Set(streamInfo.Key, s)
// 	} else {
// 		v, _ := server.conns.Get(streamInfo.Key)
// 		s = v.(*Source)
// 	}
// 	return s, nil
// }
